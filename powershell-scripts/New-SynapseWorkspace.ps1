...
process {
    ...
    $dev_privateEndpointConn = New-AzPrivateLinkServiceConnection -Name ($WorkspaceName + "_pls") -PrivateLinkServiceId $Workspace.Id -GroupId “dev”
    $dev_privateEndpoint = New-AzPrivateEndpoint -ResourceGroupName $ResourceGroupName -Name ($WorkspaceName + "_pe") -Location $Location -Subnet $subnet -PrivateLinkServiceConnection $dev_privateEndpointConn
